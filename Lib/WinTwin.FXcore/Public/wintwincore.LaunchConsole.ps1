function wintwincore.LaunchConsole {
    ...
    if ($resolvedMode -eq 'framework') {
        ...
        # DANGER-ZONE:
        # The following code block contains a logic error! It writes the provided log file
        # back into the configuration of the tool that attempted to launch the console.
        <#
