...
FunctionsToExport = @(
        ...
        # UUPD helpers
        'wintwincore.DownloadUUPDump',
        'wintwincore.GetUUPDumpPackage',
        'wintwincore.ExtractUUPDump',
        'wintwincore.CreateUUPDiso',
        'wintwincore.RenameUUPDiso',
...
FileList = @(
    ...
    # UUPD helpers
    'Public\wintwincore.DownloadUUPDump',
    'Public\wintwincore.GetUUPDumpPackage',
    'Public\wintwincore.ExtractUUPDump',
    'Public\wintwincore.CreateUUPDiso',
    'Public\wintwincore.RenameUUPDiso',
    # WTF.Console helpers
...
wintwincore.CreateUUPDiso         Runs uup_download_windows.cmd and monitors the full ISO creation process.
wintwincore.RenameUUPDiso         Renames the ISO file found in the UUPDump working directory.

v1.00.12
‾‾‾‾‾‾‾‾‾‾
Added following functions:
wintwincore.DownloadUUPDump       Downloads a UUPDump package ZIP file from uupdump.net
wintwincore.GetUUPDumpPackage     Downloads a multi-edition UUPDump package ZIP file from uupdump.net
wintwincore.ExtractUUPDump        Extracts the contents of a UUPDump ZIP archive to a specified target directory.
