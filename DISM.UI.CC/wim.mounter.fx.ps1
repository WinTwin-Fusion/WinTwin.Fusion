...
.DESCRIPTION
    This file is dot-sourced automatically by ducc.wim.mounter.ps1 at startup
    ...
    PowerEdge and keeps ducc.wim.mounter.ps1 short and easy to read.
...
#        throw "ducc.wim.mounter: No language file found (looked for '$requestedFile' and '$fallbackFile')."
#    }
#
#    try {
...
#    }
#    catch {
#        throw "ducc.wim.mounter: Failed to parse language file '$targetFile': $($_.Exception.Message)"
#    }
#}
